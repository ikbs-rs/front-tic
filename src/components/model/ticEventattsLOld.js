...
import Multi from './1Multi';

export default React.memo(function TicEventattsL(props) {
...
const hendleValueEditor = useCallback(async  (e) => {
    console.log("111111111111111111111111111")
    await valueEditor(e.rowData, e.field, e);
...
const valueEditor = (rowData, field, e) => {
    ...
    switch (rowData.inputtp) {
        ...
        case '7':
            ...
            return    <div className="card flex justify-content-center">    <MultiSelect
                id={rowData.id}
